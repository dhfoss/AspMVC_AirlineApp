        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskCompleteMessage = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightTasks", x => x.FlightTaskId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextFlightTaskFlightTaskId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Flights", x => x.FlightId);
                    table.ForeignKey(
                        name: "FK_Flights_FlightTasks_NextFlightTaskFlightTaskId",
                        column: x => x.NextFlightTaskFlightTaskId,
                        principalTable: "FlightTasks",
                        principalColumn: "FlightTaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Flights_NextFlightTaskFlightTaskId",
                table: "Flights",
                column: "NextFlightTaskFlightTaskId");
        }
